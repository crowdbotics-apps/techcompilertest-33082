...
## Project Structure
    ...
    ├── techcompilertest_33082  # Django project configurations
...
1. Clone this repo and `cd techcompilertest_33082`
...
2. Clone this repo and `cd techcompilertest_33082`
